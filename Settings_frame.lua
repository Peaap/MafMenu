...
local MAF_FONT = "Interface\\AddOns\\MafMenu\\Fonts\\Expressway.ttf"
...
settings:SetFrameStrata("BACKGROUND")
...
close:SetNormalTexture ([[Interface\AddOns\MafMenu\Icons\x]])
close:SetScript("OnEnter", function(self)
    self:SetNormalTexture ([[Interface\AddOns\MafMenu\Icons\x-red]])
end)
close:SetScript("OnLeave", function(self)
    self:SetNormalTexture ([[Interface\AddOns\MafMenu\Icons\x]])
end)
...
normal:SetNormalTexture ([[Interface\AddOns\MafMenu\Icons\EC128]])
--settings title2
...
SetMafFont(title2_text, 12, "OUTLINE")
...
SetMafFont(textbox_text, 10, "OUTLINE")
...
SetMafFont(textbox2_text, 10, "OUTLINE")
...
SetMafFont(textboxMinlevel_text, 10, "OUTLINE")
...
SetMafFont(textboxMaxlevel_text, 10, "OUTLINE")
...
SetMafFont(textboxTeamDisableID_text, 10, "OUTLINE")
...
SetMafFont(textboxRadius_text, 10, "OUTLINE")
...
SetMafFont(textboxZoneID_text, 10, "OUTLINE")
