...
Services.entries = {
    ...
    { key = "botFollow", buttonName = "buttonBotFollow", label = "Bots Follow", tooltip = "Playerbots Follow", section = "playerbots", macro = "/p follow", icon = "Interface\\Icons\\Ability_Hunter_AspectOfTheMonkey" },
    { key = "botAttack", buttonName = "buttonBotAttack", label = "Bots Attack", tooltip = "Playerbots Attack", section = "playerbots", macro = "/p attack", icon = "Interface\\Icons\\Ability_GhoulFrenzy" },
    { key = "botStay", buttonName = "buttonBotStay", label = "Bots Stay", tooltip = "Playerbots Stay", section = "playerbots", macro = "/p stay", icon = "Interface\\Icons\\Ability_Warrior_DefensiveStance" },
    { key = "botSummon", buttonName = "buttonBotSummon", label = "Bots Summon", tooltip = "Playerbots Summon", section = "playerbots", macro = "/p summon", icon = "Interface\\Icons\\Spell_Arcane_Blink" },
}
...
function MafMenu:ProbeCommands(msg)
    ...
    if table.getn(commands) == 0 then
        commands = {
            ...
            "lootbot", "playerbots", "playerbots bank", "playerbots vendor",
            "playerbots trainer", "account", "server",
        }
    end
