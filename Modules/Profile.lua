...
function Profile.Normalize(savedVars)
    ...
    if savedVars.sectionVisibility.playerbots == nil then savedVars.sectionVisibility.playerbots = true end
    ...
    savedVars.playerbots = savedVars.playerbots or {}
    savedVars.playerbots.botNames = savedVars.playerbots.botNames or ""
    savedVars.playerbots.accountName = savedVars.playerbots.accountName or ""
    savedVars.playerbots.className = savedVars.playerbots.className or ""
    savedVars.playerbots.whisperTarget = savedVars.playerbots.whisperTarget or ""
    savedVars.playerbots.customCommand = savedVars.playerbots.customCommand or ""
    savedVars.playerbots.disperseDistance = math.max(1, math.min(100, savedVars.playerbots.disperseDistance or 10))
    return savedVars
end
